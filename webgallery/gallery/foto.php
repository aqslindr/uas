...
<body style="background-color: black; color: white;">
	...
	<div class="container body" style="background-color: black;">
		<?php

		$id = $_GET['id'];
		$query = $db->query("SELECT * FROM galeri WHERE id='$id'") or die($db->error);
		if($query->num_rows){
			...
			<div class="row">
				...
				<div class="col-md-4">
					<table class="table">
						...
						<tr>
							<td colspan="2"><button style="width: 100%; background-color: #e60000;"><a href="delete_gambar.php?id='.$id.' " style="color: white; background-color: #e60000;">Delete</a></button></td>
						</tr>
					</table>
				</div>
			</div>
